...
this.languages = {
  ...
  insertTopNav () {
      ...
      `<div class="tc-titleWrapper">
        <div class="tc-titleWrapper-nav">
          <div class="tc-titleWrapper-nav-logo-settings">
            <svg class="tc-titleWrapper-nav-logo-svg" style="transform: scaleX(-1);" viewBox="0 0 1000 1000" x="0px" y="0px">
    ...
    this.globalSearch();
    this.localSearch();
    const twitchcordLogo = document.getElementsByClassName('tc-titleWrapper-nav-logo-settings')[0];
    twitchcordLogo.addEventListener('click', () => {this.openTCMenu(0)}, false);
